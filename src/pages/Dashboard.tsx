  ...
  return (
    <div className="flex flex-col items-center gap-1 select-none">
      ...
      <div className="flex items-baseline">
        <span className="text-[80px] leading-none font-extralight text-white tabular-nums tracking-tight">
          {main}
        </span>
...
function IdleSummary({
  ...
  return (
    <div className="flex flex-col items-center gap-6 select-none w-full max-w-md">
      {/* Big total */}
      ...
      <div className="w-full space-y-2">
        {categories.map((ct) => {
          const maxSeconds = categories[0]?.seconds || 1;
            ...
            <div key={ct.category} className="flex items-center gap-3">
              ...
              <div className="flex-1 h-2 bg-white/[0.03] rounded-full overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${pct}%`,
                    backgroundColor: CATEGORY_COLORS[ct.category] || CATEGORY_COLORS.unknown,
                  }}
                />
              </div>
    ...
    <div className="h-full flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center relative z-10">
        {currentSession ? (
          ...
          <IdleSummary totalSeconds={totalSeconds} categories={categoryTotals} />
        )}
      </div>
