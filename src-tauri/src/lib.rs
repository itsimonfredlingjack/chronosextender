...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::approve_timesheet_events,
            commands::set_timesheet_events_status,
            commands::approve_timesheet_day,
            commands::approve_timesheet_range,
            commands::create_manual_time_entry,
            commands::update_manual_time_entry,
            commands::delete_manual_time_entry,
            commands::set_manual_time_entry_status,
